...
!function webpackUniversalModuleDefinition(e, t) {
  if ("object" == (typeof exports === "undefined" ? "undefined" : _typeof2(exports)) && "object" == (typeof module === "undefined" ? "undefined" : _typeof2(module))) module.exports = t(require("jquery"));else if ("function" == typeof define && define.amd) define(["jquery"], t);else {
    var a = "object" == (typeof exports === "undefined" ? "undefined" : _typeof2(exports)) ? t(require("jquery")) : t(e.jQuery);

    for (var i in a) {
      ("object" == (typeof exports === "undefined" ? "undefined" : _typeof2(exports)) ? exports : e)[i] = a[i];
    }
  }
      ...
      function maskScope(e, t, F) {
        ...
        function getMaskTemplate(e, t, a, i, n) {
          ...
          do {
            ...
            "auto" === F.keeppublic && o.newBlockMarker && null !== o.fn && (F.keeppublic = c - 1), c++;
              ...
              if (e.matches !== V) {
                if (e.isGroup && a !== e) {
                  ...
                  if (-1 === u || "string" == typeof u) {
                    ...
                    (!0 === F.keeppublic || isFinite(parseInt(F.keeppublic)) && p >= F.keeppublic) && (g = g.slice(0, 1));
        ...
        function isValid(u, e, t, c, a, i) {
          ...
          if (L.isFunction(F.preValidation) && !t && !0 !== c && !0 !== i && (r = F.preValidation(getBuffer(), n, e, isSelection(u), F, getMaskSet())), !0 === r) {
            ...
            !1 !== r || !1 === F.keeppublic || null != F.regex && !isComplete(getBuffer()) || t || !0 === a || (r = alternate(n, e, t, c)), !0 === r && (r = {
              pos: n
            });
          }
        ...
        function revalidateMask(e, t, a, i) {
          function IsEnclosedpublic(e, t, a) {
            var i = t[e];
          ...
          if (e.begin > e.end && (n = e.end, r = e.begin), i = i !== V ? i : n, n !== r || F.insertMode && getMaskSet().validPositions[i] !== V && a === V) {
            ...
            for (t && (getMaskSet().validPositions[i] = L.extend(!0, {}, t), p++, u++, n < r && f++); f <= o; f++) {
              ...
              if (g !== V && (r <= f || n <= f && !0 !== g.generatedInput && IsEnclosedpublic(f, s, {
                begin: n,
                end: r
              }))) {
                ...
                if (u && (k ? e.end = e.begin : e.begin = e.end), e.begin === e.end) switch (F.positionCaretOnClick) {
                  ...
                  default:
                    ...
                    if (a < n) caret(c, isMask(a, !0) || isMask(a - 1, !0) ? a : seekNext(a));else {
                      ...
                      if ("" !== o && getBuffer()[n] !== o && !0 !== s.match.optionalQuantifier && !0 !== s.match.newBlockMarker || !isMask(n, F.keeppublic) && s.match.def === o) {
                        var l = seekNext(n);
                        (l <= a || a === n) && (n = l);
                      }
        ...
        function handleRemove(e, t, a, i, n) {
          ...
          if (t === Inputmask.keyCode.BACKSPACE && a.end - a.begin < 1 ? (a.begin = seekPrevious(a.begin), getMaskSet().validPositions[a.begin] !== V && getMaskSet().validPositions[a.begin].input === F.groupSeparator && a.begin--) : t === Inputmask.keyCode.DELETE && a.begin === a.end && (a.end = isMask(a.end, !0) && getMaskSet().validPositions[a.end] && getMaskSet().validPositions[a.end].input !== F.radixPoint ? a.end + 1 : seekNext(a.end) + 1, getMaskSet().validPositions[a.begin] !== V && getMaskSet().validPositions[a.begin].input === F.groupSeparator && a.end++), revalidateMask(a), !0 !== i && !1 !== F.keeppublic || null !== F.regex) {
            var s = alternate(!0);
        ...
        function renderColorMask(e, t, a) {
          ...
          function setEntry(e) {
            ...
            } else o = !0, s.push("<span class='im-public'>" + e);
          }
          ...
          function insertTestDefinition(a, e, i) {
            ...
            if (r) 0 === e.indexOf("[") || p && /\\d|\\s|\\w]/i.test(e) || "." === e ? a.matches.splice(i++, 0, {
              ...
              n = a.matches[i - 1], a.matches.splice(i++, 0, {
                ...
                casing: null,
                def: s.publicDefinitionSymbol || t,
                placeholder: s.publicDefinitionSymbol !== V ? t : V,
                nativeDef: (p ? "'" : "") + t
              });
            })), p = !1;else {
              ...
              t && !p ? a.matches.splice(i++, 0, {
                ...
                casing: null,
                def: s.publicDefinitionSymbol || e,
                placeholder: s.publicDefinitionSymbol !== V ? e : V,
                nativeDef: (p ? "'" : "") + e
              }), p = !1);
            }
          }
