...
//Кастомный autoplay для слайдера с категориями товаров
...
//Слайдер с фотографиями на детальной странице товара (Внутренняя и внешняя отделка)
...
setInterval(autoplayBackSlider, 10000);

//Слайдер с фотографиями на детальной странице товара
